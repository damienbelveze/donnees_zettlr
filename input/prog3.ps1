...
pandoc mypdf\$filename.md --bibliography .\biblio\biblio/Obsidian.bib --csl .\csl\$stylename.csl --pdf-engine=xelatex --citeproc -f markdown+smart -o mypdf\$filename.pdf
